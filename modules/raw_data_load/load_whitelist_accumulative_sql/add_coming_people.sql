insert into langxin_community.residents_accumulative (`街道`,`社区`,`网格`,`所居住花园小区/城中村名称`,`所属电子哨兵卡口名称`,`姓名`,`性别`,`人员类型`,`证件类型`,`证件号码`,
...
from
    langxin_community.residents_accumulative r right join
    langxin_community.new_residents_accumulative nr
on
    r.证件号码 = nr.证件号码 and
    r.房屋编码 = nr.房屋编码 and
    r.加入白名单时间 = '{date}'
